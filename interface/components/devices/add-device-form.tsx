  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <Tabs defaultValue="templates" className="mt-4 flex-1 flex flex-col">
          ...
          <div className="flex-1 overflow-auto">
            <TabsContent value="templates" className="space-y-4 py-4 h-full">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {/* Device template buttons */}
                <Button
                  variant={deviceType === "led" ? "default" : "outline"}
                  className="flex flex-col h-20 md:h-24 gap-2"
            ...
            <TabsContent value="custom" className="space-y-4 py-4 h-full">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
        ...
        <DialogFooter className="mt-4 sticky bottom-0 bg-background pt-2 border-t">
          <Button
